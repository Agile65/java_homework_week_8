...
public class Program_16Point {
    ...
    //method 7
    public double distance(Program_16Point secondPoint){
        return distance(secondPoint.x,secondPoint.y);
    }
    //main method
    public static void main(String[] args) {
        Program_16Point first=new Program_16Point(6,5);
        Program_16Point second=new Program_16Point(3,1);
        System.out.println("distance(0,0)= " +first.distance());
        System.out.println("distance(second) = " +first.distance(second));
        System.out.println("distance(2,2)= "+first.distance(2,2));
        Program_16Point point=new Program_16Point();
        System.out.println("distance()= "+point.distance());
    }
}
